  ...
  <div className="contain m-auto min-h-halfscreen mb-5 text-center">
    {props.geo.countryCode === 'US' && (
      <h1 className="mb-1">
        ...
        <br />If this page belongs to a private or hidden group, you need to join the group first.
      </h1>
    )}
    {props.geo.countryCode !== 'US' && (
      <h1>
        You&apos;re seeing this because you are outside the US.
        <br />We&apos;re working on having Consensus available for everyone as soon as possible!
      </h1>
    )}
  </div>
));
