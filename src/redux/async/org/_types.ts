...
export const POST_ORG_BEGIN = 'POST_ORG_BEGIN';
...
export type tBeginAction = tAction<
  typeof GET_ORG_BEGIN
  | typeof PATCH_ORG_BEGIN
  | typeof POST_ORG_BEGIN
>;

export type tSuccessAction = tAction<
  typeof GET_ORG_SUCCESS
  | typeof PATCH_ORG_SUCCESS
  | typeof POST_ORG_SUCCESS,
  tThunk<tOrg>
>;

export type tFailureAction = tAction<
  typeof GET_ORG_FAILURE
  | typeof PATCH_ORG_FAILURE
  | typeof POST_ORG_FAILURE,
  Error
>;
